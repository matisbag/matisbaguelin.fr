<template>
  <footer class="w-full text-white bg-gray-100 dark:bg-gray-900">
    <div class="mx-auto px-4 py-14 max-w-7xl sm:px-6 lg:px-8">
      <div class="flex justify-center space-x-6">
        <a
          href="https://www.linkedin.com/in/matis-baguelin/"
          target="_blank"
          rel="noopener"
          class="dark:text-gray-200 hover:text-gray-300 text-gray-800 transition duration-500"
        >
        ...
        <a
          href="mailto:matis.baguelin@gmail.com"
          class="dark:text-gray-200 hover:text-gray-300 text-gray-800 transition duration-500"
        >
