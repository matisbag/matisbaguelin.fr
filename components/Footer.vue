  ...
  <footer class="bg-gray-800 text-white w-full">
    <div class="max-w-7xl mx-auto py-14 px-4 sm:px-6 lg:px-8">
      <div class="flex justify-center space-x-6">
        <a href="https://www.linkedin.com/in/matis-baguelin/" target="_blank" class="text-gray-200 hover:text-white transition duration-500">
        ...
        <a href="https://github.com/MatisBag/" target="_blank" class="text-gray-200 hover:text-white transition duration-500">
        ...
        <a href="mailto:matis.baguelin@gmail.com" class="text-gray-200 hover:text-white transition duration-500">
