  ...
  <section id="about" class="max-w-7xl mx-auto py-12 px-4 sm:px-6 sm:py-24 lg:py-36 lg:px-8">
    <div class="text-center">
      ...
      <p class="mt-3 max-w-md mx-auto text-base text-gray-300 font-medium sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
        Jeune développeur depuis 2020, je suis passioné par le développement web.
      ...
      <div class="mt-8 flex justify-center">
        <div class="inline-flex rounded-md shadow">
          <a href="https://github.com/MatisBag/" target="_blank"
            class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-black hover:bg-emerald-500 duration-500">
            Github &#160;
        ...
        <div class="ml-3 inline-flex rounded-md shadow">
          <a href=""
            class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-emerald-500 bg-black hover:text-emerald-600 duration-500">
            CV &#160;
