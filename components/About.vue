<template>
  <section id="about" class="max-w-7xl mx-auto py-12 sm:px-4 sm:py-24 lg:py-36 lg:px-6">
    <div class="text-center">
      ...
      <p class="mt-3 max-w-md mx-auto text-base text-gray-600 dark:text-gray-300 font-medium sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
      ...
      <div class="mt-8 flex justify-center">
        <div class="inline-flex rounded-md shadow">
          <a href="https://github.com/MatisBag/" target="_blank" rel="noopener" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-900 dark:bg-black hover:bg-green-500 duration-500">
            Github &#160;
