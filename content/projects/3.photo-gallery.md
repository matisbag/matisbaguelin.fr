---
title: "Photo Gallery"
description: "Photo Gallery is an application built with Next.js. It is inspired by Google Photos, offering a simplified user interface and a smooth navigation experience."
...
### Technologies Used
This application was built with [Next.js](https://nextjs.org/) for the front-end and [Supabase](https://supabase.com/) for data management and user authentication. I also used [Material-UI](https://mui.com/) for styling and layout, to ensure a functional user interface without spending too much time on design.
